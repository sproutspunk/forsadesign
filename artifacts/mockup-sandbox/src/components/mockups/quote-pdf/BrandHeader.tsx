    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-8 py-12">
      ...
      >
        ...
        <header className="bg-[#0D2540] text-white pt-12 pb-16 px-14 flex justify-between items-start">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="w-10 h-10 relative flex-shrink-0">
              <div className="absolute inset-0 bg-[#C9A84C] opacity-80" style={{ clipPath: "polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)" }}></div>
              <div className="absolute inset-1 bg-[#0D2540]" style={{ clipPath: "polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)" }}></div>
              <div className="absolute inset-0 flex items-center justify-center font-serif text-[#C9A84C] font-bold text-lg italic">F</div>
            </div>
            {/* Text */}
            <div className="flex flex-col">
              <span className="font-serif text-2xl tracking-widest uppercase font-semibold text-white leading-none">Forsa</span>
              <span className="font-sans text-[0.65rem] tracking-[0.3em] uppercase text-[#C9A84C] mt-1">Design Studio</span>
            </div>
          </div>
        ...
        <section className="px-14 py-12 flex justify-between items-end border-b border-gray-100">
          <div>
            <h3 className="text-xs font-semibold uppercase tracking-widest text-gray-400 mb-2">Prepared For</h3>
        ...
        <section className="px-14 py-10 flex gap-12 h-[550px]">
            ...
            <div className="space-y-6">
              ...
              <div className="group">
                <div className="flex justify-between items-end mb-1">
                  <h4 className="font-serif text-[#0D2540] font-medium text-lg">Discovery & UX Strategy</h4>
                ...
                <p className="text-sm text-gray-500 leading-relaxed pr-8">
                  Stakeholder interviews, user journey mapping, wireframing, and comprehensive sitemap development.
                </p>
              </div>
              ...
              <div className="group">
                <div className="flex justify-between items-end mb-1">
                  <h4 className="font-serif text-[#0D2540] font-medium text-lg">UI Design & Prototyping</h4>
                  <span className="text-[#0D2540] font-medium">£1,600</span>
                </div>
                <div className="w-full h-[1px] bg-gray-100 mb-2"></div>
                <p className="text-sm text-gray-500 leading-relaxed pr-8">
                  Custom high-fidelity visual design for desktop and mobile, interactive prototype, and design system creation.
                </p>
              </div>
              ...
              <div className="group">
                <div className="flex justify-between items-end mb-1">
                  <h4 className="font-serif text-[#0D2540] font-medium text-lg">Frontend Development</h4>
                  <span className="text-[#0D2540] font-medium">£1,900</span>
                </div>
                <div className="w-full h-[1px] bg-gray-100 mb-2"></div>
                <p className="text-sm text-gray-500 leading-relaxed pr-8">
                  Responsive React/Next.js implementation, custom animations, accessibility compliance (WCAG AA), and performance optimization.
                </p>
              </div>
              ...
              <div className="group">
                <div className="flex justify-between items-end mb-1">
                  <h4 className="font-serif text-[#0D2540] font-medium text-lg">Testing & Launch</h4>
                  <span className="text-[#0D2540] font-medium">£500</span>
                </div>
                <div className="w-full h-[1px] bg-gray-100 mb-2"></div>
                <p className="text-sm text-gray-500 leading-relaxed pr-8">
                  Cross-browser testing, CMS integration support, SEO foundation, and deployment assistance.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="w-[280px] flex flex-col">
            ...
            <div className="bg-[#0D2540] text-white p-8 rounded-sm mb-8 shadow-lg relative overflow-hidden">
              ...
              <h3 className="text-xs font-semibold uppercase tracking-widest text-[#C9A84C] mb-2">Total Investment</h3>
