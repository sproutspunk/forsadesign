      ...
      <div className="w-[210mm] h-[297mm] bg-white shadow-2xl relative overflow-hidden">
        ...
        <div className="relative z-10 h-full flex flex-col">
          ...
          <header className="border-b-2 border-navy px-12 pt-12 pb-8">
            <div className="flex items-start justify-between">
              ...
              <div className="flex flex-col">
                <div className="font-serif text-4xl tracking-tight text-navy mb-1" style={{ fontFamily: 'Georgia, serif', fontWeight: 600 }}>
                  FORSA
                </div>
                <div className="text-[10px] tracking-[0.3em] text-gold uppercase font-medium" style={{ fontFamily: 'system-ui, sans-serif' }}>
                  Design Studio
                </div>
              </div>
              ...
              <div className="text-right">
                <div className="text-xs text-navy/50 uppercase tracking-wider mb-1">Commercial Quotation</div>
          ...
          <section className="px-12 py-8 grid grid-cols-2 gap-12 border-b border-navy/10">
            <div>
              ...
              <div className="text-xs text-navy/60 mt-1 leading-relaxed">
                Unit 12, Westgate Industrial Park<br />
                Birmingham, B28 9QR<br />
                United Kingdom
              </div>
            </div>
            <div>
              <div className="text-[10px] uppercase tracking-widest text-gold mb-2">Project Scope</div>
              <div className="text-sm font-medium text-navy">Corporate Website Redesign</div>
              <div className="text-xs text-navy/60 mt-1 leading-relaxed">
                Full digital presence overhaul including responsive<br />
          ...
          <section className="px-12 py-8 flex-1">
            <div className="text-[10px] uppercase tracking-widest text-gold mb-4">Detailed Scope</div>
            
            <table className="w-full text-xs">
              <thead>
                <tr className="border-b-2 border-navy">
                  <th className="text-left py-3 font-semibold text-navy uppercase tracking-wider text-[10px]">Item</th>
                  <th className="text-left py-3 font-semibold text-navy uppercase tracking-wider text-[10px]">Description</th>
                  <th className="text-right py-3 font-semibold text-navy uppercase tracking-wider text-[10px]">Units</th>
                  <th className="text-right py-3 font-semibold text-navy uppercase tracking-wider text-[10px]">Amount</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-navy/10">
                  <td className="py-4 text-navy font-medium">Design & UX</td>
                  <td className="py-4 text-navy/70">User research, wireframes, high-fidelity mockups</td>
                ...
                <tr className="border-b border-navy/10">
                  ...
                  <td className="py-4 text-navy/70">React implementation, responsive build, CMS setup</td>
            ...
            <div className="mt-8 grid grid-cols-2 gap-8">
              <div>
                <div className="text-[10px] uppercase tracking-widest text-gold mb-3">Technical Inclusions</div>
              ...
              <div>
                <div className="text-[10px] uppercase tracking-widest text-gold mb-3">Delivery Timeline</div>
          ...
          <footer className="border-t-2 border-navy px-12 py-8">
            <div className="flex justify-between items-end">
              <div className="text-xs text-navy/50 max-w-md leading-relaxed">
                <p className="mb-2">This quotation is valid for 30 days from the date of issue. A 50% deposit is required to commence work, with the balance due upon project completion.</p>
                <p className="text-[10px]">All amounts exclude VAT at the prevailing rate.</p>
              </div>
              <div className="text-right">
                <div className="text-[10px] uppercase tracking-widest text-gold mb-1">Total Investment</div>
