...
const content = {
  en: {
    ...
    tableRows: [
      ...
      ["Communication", "Support tickets", "Direct", "Account manager", "Direct with developer"],
      ["Design", "Template-based", "Varies", "Custom", "Fully custom"],
      ["Performance", "Depends on platform", "Varies", "Usually optimised", "Performance-focused"],
      ["SEO Foundation", "Basic", "Varies", "Included", "Built-in from day one"],
      ["Integrations", "Limited", "Depends on skills", "Available", "Custom integrations"],
      ["Support", "Self-managed", "Limited", "Ongoing", "Ongoing partnership"],
      ["Ownership", "Platform dependent", "Usually full", "Usually full", "Full ownership"],
      ["Scalability", "Limited", "Varies", "Good", "Built for growth"],
    ],
  ...
  pl: {
    ...
    tableRows: [
      ...
      [
        ...
        "Bezpo\u015brednia",
        "Account manager",
        "Bezpo\u015brednia z deweloperem",
      ],
      ["Design", "Szablonowy", "Zale\u017cy", "Dostosowany", "W pe\u0142ni indywidualny"],
      [
        "Wydajno\u015b\u0107",
        "Zale\u017cy od platformy",
        "Zale\u017cy",
        "Zazwyczaj zoptymalizowana",
        "Skupiona na wydajno\u015bci",
      ],
      [
        "Fundament SEO",
        "Podstawowy",
      ...
      ["Skalowalno\u015b\u0107", "Ograniczona", "Zale\u017cy", "Dobra", "Zbudowana na rozw\u00f3j"],
    ],
